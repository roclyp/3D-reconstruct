...
int main()
{
	...
	int errors = pcl::io::loadPCDFile<pcl::PointXYZRGBA>("C:\\Users\\Zhihong MA\\Desktop\\test2017.9.22\\Test1.pcd", *Incloud);
	if (errors == -1)
	{
	...
	PassCloud = PassThroughway(Incloud, "x", -1, 1);
	PassCloud = PassThroughway(PassCloud, "y", -0.3, 0);
	PassCloud = PassThroughway(PassCloud, "z", -1, 1);
	...
	//string outpath = "C:/Users/Zhihong MA/Desktop/test2017.9.22/AfterFilter/";
	////string outname = ;
	//pcl::savePCDFileBinary("C:/Users/Zhihong MA/Desktop/test2017.9.22/AfterFilter/",StatistCloud);
